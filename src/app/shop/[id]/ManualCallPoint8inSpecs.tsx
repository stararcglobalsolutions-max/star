...
export function ManualCallPoint8inSpecs({ slug }: { slug: string }) {
  if (slug !== 'manual-call-point-8in' && slug !== 'manual-call-point') return null;

  const BASE = '/images/products/manual-call-point-8in';
      ...
      <div className="w-full flex flex-col gap-0">
        ...
        {PAGES.map((page) => (
          <div key={page.num} className="w-full bg-white">
            <img
              src={page.src}
              alt={`Manual Call Point Product Documentation - Page ${page.num}`}
