      ...
      <div className="max-w-[1440px] mx-auto px-6 lg:px-16 xl:px-20 py-16 lg:py-24">
        ...
        <div className="flex flex-col-reverse lg:flex-row gap-16 lg:gap-24 mb-24 items-start">
          <div className="w-full lg:w-[60%] flex flex-col">
            <div className="flex justify-between items-start mb-10">
              <div>
                <h2 className="text-[40px] lg:text-[48px] font-bold leading-tight tracking-tight mb-4 text-[#0f2b4c]">Hub 2 (2G) Jeweller</h2>
                <p className="text-[20px] lg:text-[22px] text-slate-500 leading-relaxed max-w-2xl">
                  Security system control panel with 3 communication channels: Ethernet and 2 SIM cards (2G). Supports photo verification provided by detectors of the MotionCam series.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-8 mb-16">
              <div className="flex items-start gap-5">
                ...
                <p className="text-[16px] leading-snug text-slate-700">Free over-the-air software updates</p>
              </div>
              <div className="flex items-start gap-5">
                <div className="w-2 h-2 rounded-full bg-[#0f2b4c] mt-2 shrink-0"></div>
                <p className="text-[16px] leading-snug text-slate-700">Connection to CMS</p>
              </div>
              <div className="flex items-start gap-5">
                <div className="w-2 h-2 rounded-full bg-[#0f2b4c] mt-2 shrink-0"></div>
                <p className="text-[16px] leading-snug text-slate-700">Integration with third-party CCTV cameras or DVRs</p>
              </div>
              <div className="flex items-start gap-5">
                <div className="w-2 h-2 rounded-full bg-[#0f2b4c] mt-2 shrink-0"></div>
                <p className="text-[16px] leading-snug text-slate-700">Informing users with push notifications, calls, and SMS</p>
              </div>
            </div>
            ...
            <div className="space-y-6 mb-16">
              <p className="text-[16px] lg:text-[18px] text-slate-600 leading-relaxed">
                To guarantee timely alarm transmission to the security company and users, Hub 2 supports connection to three Internet providers simultaneously: via Ethernet and two SIM cards with a 2G cellular network. Communication channels operate in parallel, and automatic switching between them takes seconds.
              </p>
              <p className="text-[16px] lg:text-[18px] text-slate-600 leading-relaxed">
                The Ajax product portfolio includes Hub 2 with a 4G cellular modem. This version supports 2G, 3G, and LTE cellular networks. Please note that 2G/3G networks have been shut down in some regions or are planned to be disabled soon.
              </p>
            </div>

            <h3 className="text-[24px] lg:text-[28px] font-bold mb-6 text-[#0f2b4c]">In-app control and configuration</h3>
            <div className="space-y-6">
              <p className="text-[16px] lg:text-[18px] text-slate-600 leading-relaxed">
                Hub is connected to Ajax apps, security companies, and users via a secure channel through the Ajax Cloud server located in several AWS data centres. Server availability is 99.995%.
              </p>
              <p className="text-[16px] lg:text-[18px] text-slate-600 leading-relaxed">
                Intuitive Ajax apps provide remote configuration and all information about system devices from anywhere the Internet is available, on a smartphone or PC. An installer can remotely change the settings and provide services in time — no need to visit the object.
              </p>
            </div>
          </div>
          ...
          <div className="w-full lg:w-[40%] flex flex-col items-center lg:items-end sticky top-24">
            ...
            <div className="w-full flex justify-center lg:justify-end">
              <img src="/pdf_images/hub2_page0_img0.png" alt="Hub 2 Jeweller" className="w-full max-w-[450px] object-contain drop-shadow-xl" />
            </div>
          </div>
        </div>
        ...
        <div className="mb-24">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 mb-24">
            <div>
              <h3 className="text-[28px] lg:text-[34px] font-bold mb-8 text-[#0f2b4c]">Sabotage-resistant</h3>
              <ul className="space-y-4">
                <li className="flex items-start gap-4">
                   <div className="w-2 h-2 rounded-full bg-[#0f2b4c] mt-2 shrink-0"></div>
                   <span className="text-[16px] lg:text-[18px] text-slate-600">Built-in backup battery giving up to 16 hours of autonomous operation</span>
                </li>
                <li className="flex items-start gap-4">
                   <div className="w-2 h-2 rounded-full bg-[#0f2b4c] mt-2 shrink-0"></div>
                   <span className="text-[16px] lg:text-[18px] text-slate-600">Detecting loss of connection with Ajax Cloud in 1 minute</span>
                </li>
                <li className="flex items-start gap-4">
                   <div className="w-2 h-2 rounded-full bg-[#0f2b4c] mt-2 shrink-0"></div>
                   <span className="text-[16px] lg:text-[18px] text-slate-600">Detecting loss of connection with devices in 36 seconds</span>
                </li>
                <li className="flex items-start gap-4">
                   <div className="w-2 h-2 rounded-full bg-[#0f2b4c] mt-2 shrink-0"></div>
                   <span className="text-[16px] lg:text-[18px] text-slate-600">Tamper alarm</span>
                </li>
              </ul>
            </div>
            <div>
              ...
              <p className="text-[16px] lg:text-[18px] text-slate-600 leading-relaxed mb-6">
                An Ajax system uses two-way secure radio communication based on Jeweller and Wings proprietary protocols. Radio protocols work in parallel and focus on their function, guaranteeing instant data delivery despite weak signal and communication interruptions.
              </p>
              <ul className="space-y-4">
                <li className="flex items-start gap-4">
                   <div className="w-2 h-2 rounded-full bg-[#0f2b4c] mt-2 shrink-0"></div>
                   <span className="text-[16px] lg:text-[18px] text-slate-600">Encrypted two-way radio communication</span>
                </li>
                <li className="flex items-start gap-4">
                   <div className="w-2 h-2 rounded-full bg-[#0f2b4c] mt-2 shrink-0"></div>
                   <span className="text-[16px] lg:text-[18px] text-slate-600">Frequency hopping against radio interference and signal interception</span>
                </li>
                <li className="flex items-start gap-4">
                   <div className="w-2 h-2 rounded-full bg-[#0f2b4c] mt-2 shrink-0"></div>
                   <span className="text-[16px] lg:text-[18px] text-slate-600">Automatic power adjustment of radio transmitters</span>
                </li>
                <li className="flex items-start gap-4">
                   <div className="w-2 h-2 rounded-full bg-[#0f2b4c] mt-2 shrink-0"></div>
                   <span className="text-[16px] lg:text-[18px] text-slate-600">Notifications about jamming and connection loss</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 mb-24">
            <div className="bg-slate-50 p-8 lg:p-12 rounded-2xl">
              <h3 className="text-[28px] lg:text-[34px] font-bold mb-2 text-[#0f2b4c]">Jeweller</h3>
              <p className="text-[18px] text-slate-500 font-medium mb-8">transmits alarms, events, and all readings</p>
              <ul className="space-y-4">
                <li className="flex items-start gap-4">
                   <div className="w-2 h-2 rounded-full bg-[#0f2b4c] mt-2 shrink-0"></div>
                   <span className="text-[16px] lg:text-[18px] text-slate-600">Up to 2,000 m of radio communication in an open space</span>
                </li>
                <li className="flex items-start gap-4">
                   <div className="w-2 h-2 rounded-full bg-[#0f2b4c] mt-2 shrink-0"></div>
                   <span className="text-[16px] lg:text-[18px] text-slate-600">Encryption and device authentication to prevent spoofing</span>
                </li>
                <li className="flex items-start gap-4">
                   <div className="w-2 h-2 rounded-full bg-[#0f2b4c] mt-2 shrink-0"></div>
                   <span className="text-[16px] lg:text-[18px] text-slate-600">Regular polling to display current devices' statuses</span>
                </li>
              </ul>
            </div>
            <div className="bg-slate-50 p-8 lg:p-12 rounded-2xl">
              <h3 className="text-[28px] lg:text-[34px] font-bold mb-2 text-[#0f2b4c]">Wings</h3>
              <p className="text-[18px] text-slate-500 font-medium mb-8">transmits photos and large data packages</p>
              <ul className="space-y-4">
                <li className="flex items-start gap-4">
                   <div className="w-2 h-2 rounded-full bg-[#0f2b4c] mt-2 shrink-0"></div>
                   <span className="text-[16px] lg:text-[18px] text-slate-600">Up to 1,700 m of radio communication in an open space</span>
                </li>
                <li className="flex items-start gap-4">
                   <div className="w-2 h-2 rounded-full bg-[#0f2b4c] mt-2 shrink-0"></div>
                   <span className="text-[16px] lg:text-[18px] text-slate-600">Unique uploading algorithm and data delivery confirmation</span>
                </li>
                <li className="flex items-start gap-4">
                   <div className="w-2 h-2 rounded-full bg-[#0f2b4c] mt-2 shrink-0"></div>
                   <span className="text-[16px] lg:text-[18px] text-slate-600">Data backup and resend in case of transmission interruptions</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <h3 className="text-[28px] lg:text-[34px] font-bold mb-8 text-[#0f2b4c]">Hassle-free installation</h3>
            <p className="text-[16px] lg:text-[18px] text-slate-600 leading-relaxed mb-10">
              The hub is ready to operate straight out of the box. There is no need to disassemble the enclosure during installation. With a SmartBracket panel, an installer can effortlessly mount the hub on the wall or ceilings. The installation kit with all the necessary fasteners is included in a complete set.
            </p>
            <h4 className="text-[20px] lg:text-[24px] font-bold mb-4 text-[#0f2b4c]">Quick connection and setup</h4>
            <p className="text-[16px] lg:text-[18px] text-slate-600 leading-relaxed">
              Firstly, an installer needs to plug the hub into a power socket, and connect it to the Internet via Ethernet and SIM cards. The next step is pairing with Ajax apps by scanning the hub’s QR code or entering its ID manually. And lastly, an installer only needs to name the hub and add other Ajax devices.
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-0 border-t border-slate-200">
            ...
            <div className="flex flex-col border-r-0 lg:border-r border-slate-200">
              ...
              <div className="flex flex-col sm:flex-row border-b border-slate-200 py-6 pr-0 lg:pr-10 gap-4 sm:gap-8">
                ...
                <div className="w-full sm:w-[60%] text-[16px] text-slate-800">
                  <strong className="text-[#0f2b4c]">up to 100 wireless Ajax devices</strong><br/>
                  <span className="text-slate-500 text-sm mt-1 block">Including up to 5 range extenders and up to 10 sirens.</span>
                </div>
              </div>
              <div className="flex flex-col sm:flex-row border-b border-slate-200 py-6 pr-0 lg:pr-10 gap-4 sm:gap-8">
                <div className="w-full sm:w-[40%] text-[16px] text-slate-500 font-medium">Communication with Ajax devices</div>
                <div className="w-full sm:w-[60%] text-[16px] text-slate-800">
                  ...
                  <div className="mt-8 space-y-6">
                    <div>
                      ...
                      <span className="text-slate-500 text-sm mt-2 block">Depends on the sales region.</span>
                    </div>
                    <div>
              ...
              <div className="flex flex-col sm:flex-row border-b border-slate-200 py-6 pr-0 lg:pr-10 gap-4 sm:gap-8">
                ...
                <div className="w-full sm:w-[60%] text-[16px] text-slate-800 space-y-4">
                  <div>
                    ...
                    <span className="text-slate-600">8P8C slot</span><br/>
                    <span className="text-slate-500 text-sm mt-1 block">Up to 100 Mb/s.</span>
                  </div>
                  <div>
                    <strong className="text-[#0f2b4c] block mb-1">Cellular network</strong>
                    <span className="text-slate-600">2 slots for micro-SIM<br/>2G (GSM900/DCS1800 (B3/B8)).</span>
                  </div>
                </div>
              </div>
              <div className="flex flex-col sm:flex-row border-b border-slate-200 lg:border-b-0 py-6 pr-0 lg:pr-10 gap-4 sm:gap-8">
                ...
                <div className="w-full sm:w-[60%] text-[16px] text-slate-800 space-y-4">
                  ...
                  <div>
                    ...
                    <span className="text-slate-600">362 g</span>
                  </div>
                  <div>
                    <strong className="text-[#0f2b4c] block mb-1">Colours</strong>
                    <span className="text-slate-600">white<br/>black</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col lg:pl-10">
              <div className="flex flex-col sm:flex-row border-b border-slate-200 py-6 gap-4 sm:gap-8">
                ...
                <div className="w-full sm:w-[60%] text-[16px] text-slate-800 space-y-4">
                  ...
                  <div>
                    ...
                    <span className="text-slate-600">built-in Li-Ion battery, 2 A⋅h</span><br/>
                    <span className="text-slate-500 text-sm mt-1 block">Up to 16 hours of autonomous operation.</span>
                  </div>
                </div>
              </div>
              <div className="flex flex-col sm:flex-row border-b border-slate-200 py-6 gap-4 sm:gap-8">
              ...
              <div className="flex flex-col sm:flex-row border-b border-slate-200 py-6 gap-4 sm:gap-8">
                ...
                <div className="w-full sm:w-[60%] text-[16px] text-slate-600 leading-relaxed">
                  50 users<br/>
                  25 cameras or DVRs<br/>
                  32 automation scenarios<br/>
                  9 security groups<br/>
              ...
              <div className="flex flex-col sm:flex-row py-6 gap-4 sm:gap-8">
                ...
                <div className="w-full sm:w-[60%] text-[16px] text-slate-600 leading-relaxed">
                  Hub 2 (2G) Jeweller<br/>
                  Power cable<br/>
                  Ethernet cable<br/>
                  SIM card<br/>
                  <span className="text-slate-500 text-sm block my-1">Depends on the sales region</span>
                  Installation kit<br/>
                  Quick start guide
                </div>
              </div>
      ...
      <div className="max-w-[1440px] mx-auto px-6 lg:px-16 xl:px-20 py-16 lg:py-24">
        ...
        <div className="flex flex-col-reverse lg:flex-row gap-16 lg:gap-24 mb-24 items-start">
          <div className="w-full lg:w-[60%] flex flex-col">
            <div className="flex justify-between items-start mb-10">
              <div>
                <h2 className="text-[40px] lg:text-[48px] font-bold leading-tight tracking-tight mb-4 text-[#0f2b4c]">Hub 2 (4G)</h2>
                <p className="text-[20px] lg:text-[22px] text-slate-500 leading-relaxed max-w-2xl font-medium mb-4">
                  Security system control panel supporting alarm photo verification.
                </p>
                <p className="text-[18px] lg:text-[20px] text-slate-600 leading-relaxed max-w-2xl">
                  Has 3 independent communication channels: Ethernet and two 4G SIM cards. Automated switching between channels occurs in seconds.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-8 mb-16">
              <div className="flex items-start gap-5">
                <div className="w-2 h-2 rounded-full bg-[#0f2b4c] mt-2 shrink-0"></div>
                <p className="text-[16px] leading-snug text-slate-700">Frequency hopping against jamming.</p>
              </div>
              <div className="flex items-start gap-5">
                <div className="w-2 h-2 rounded-full bg-[#0f2b4c] mt-2 shrink-0"></div>
                <p className="text-[16px] leading-snug text-slate-700">Up to 16 hours on a backup battery¹</p>
              </div>
              <div className="flex items-start gap-5">
                <div className="w-2 h-2 rounded-full bg-[#0f2b4c] mt-2 shrink-0"></div>
                <p className="text-[16px] leading-snug text-slate-700">Over-the-air updates.</p>
              </div>
              <div className="flex items-start gap-5">
                <div className="w-2 h-2 rounded-full bg-[#0f2b4c] mt-2 shrink-0"></div>
                <p className="text-[16px] leading-snug text-slate-700">Remote setup and control via smartphone and desktop apps.</p>
              </div>
              <div className="flex items-start gap-5">
                <div className="w-2 h-2 rounded-full bg-[#0f2b4c] mt-2 shrink-0"></div>
                <p className="text-[16px] leading-snug text-slate-700">Tampering alarm.</p>
              </div>
              <div className="flex items-start gap-5">
                <div className="w-2 h-2 rounded-full bg-[#0f2b4c] mt-2 shrink-0"></div>
                <p className="text-[16px] leading-snug text-slate-700">Communication range with Ajax devices via Jeweller and Wings radio protocols is up to 2,000 m.</p>
              </div>
            </div>
            <p className="text-[14px] text-slate-400 mb-8">¹ With a hub communicating with Ajax Cloud via LTE or Ethernet</p>

            <h3 className="text-[24px] lg:text-[28px] font-bold mb-6 text-[#0f2b4c]">Features</h3>
            <div className="flex flex-col gap-4">
               <p className="text-[16px] lg:text-[18px] text-slate-600 font-medium">Grade 2 EN 50131</p>
               <p className="text-[16px] lg:text-[18px] text-slate-600 font-medium">PD 6662:2017</p>
            </div>
          </div>
          ...
          <div className="w-full lg:w-[40%] flex flex-col items-center lg:items-end sticky top-24">
            ...
            <div className="w-full flex justify-center lg:justify-end">
              <img src="/pdf_images/hub2_page0_img0.png" alt="Hub 2 4G" className="w-full max-w-[450px] object-contain drop-shadow-xl" />
            </div>
          </div>
        </div>
        ...
        <div className="mb-24">
          <div className="max-w-4xl mx-auto mb-24">
            <h3 className="text-[28px] lg:text-[34px] font-bold mb-8 text-[#0f2b4c]">More options with these two hub versions</h3>
            <div className="space-y-6">
              <p className="text-[16px] lg:text-[18px] text-slate-600 leading-relaxed">
                To meet the requirements of the professionals and today’s security market, we will manufacture and sell two Hub 2 models simultaneously. They have the same body and specifications, but only with one difference: a type of built-in cellular modem.
              </p>
              <p className="text-[16px] lg:text-[18px] text-slate-600 leading-relaxed">
                We will ship Hub 2 in two versions: with a 2G and a 4G modem. The hubs will be marked as Hub 2 (2G) and Hub 2 (4G) — and have different packaging to avoid confusion. Choose and install the equipment that precisely matches the client’s needs. We will keep producing and selling all the preceding hub models to offer you even more choices.
              </p>
              <p className="text-[16px] lg:text-[18px] text-slate-600 leading-relaxed">
                Existing Hub 2 with a 2G modem will change the name to Hub 2 (2G). We will indicate this modification in all marketing materials. Please, note that hubs with 2G cellular modems will gradually cease to be supplied in regions where 2G/3G frequencies are planned to be disabled in the near future.
              </p>
            </div>
          </div>

          <div className="mb-24">
             <h3 className="text-[28px] lg:text-[34px] font-bold mb-12 text-[#0f2b4c] text-center">Guaranteed delivery of alarms and photo confirmations</h3>
             <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
                <div className="bg-slate-50 p-8 lg:p-12 rounded-2xl">
                   <h4 className="text-[24px] lg:text-[28px] font-bold mb-6 text-[#0f2b4c]">Jeweller</h4>
                   <p className="text-[16px] lg:text-[18px] text-slate-600 leading-relaxed">
                     We have developed Jeweller radio protocol to ensure the continuous operation of all devices within the security system. It provides two-way communication between a hub and devices at a distance of up to 2,000 meters. Jeweller uses time frames to synchronize communication with connected devices, authentication to eliminate forgery, and encryption to protect against data theft.
                   </p>
                </div>
                <div className="bg-slate-50 p-8 lg:p-12 rounded-2xl">
                   <h4 className="text-[24px] lg:text-[28px] font-bold mb-6 text-[#0f2b4c]">Wings</h4>
                   <p className="text-[16px] lg:text-[18px] text-slate-600 leading-relaxed">
                     Wings is a radio protocol developed for the fast transmission of visual data over vast distances. Hub 2 (4G) uses dedicated antennas to improve channel reliability. Built-in algorithms of package checking and uploading allow Wings to deliver photos at a distance of up to 1,700 meters, even if the signal level is unstable.
                   </p>
                </div>
             </div>
          </div>

          {/* Hubs' Differences Table */}
          <div className="mb-24 overflow-x-auto">
            <h3 className="text-[28px] lg:text-[34px] font-bold mb-8 text-[#0f2b4c]">Hubs’ differences</h3>
            <table className="w-full text-left border-collapse min-w-[800px]">
              <thead>
                <tr className="border-b-2 border-slate-300">
                  <th className="p-4 text-[16px] text-slate-500 font-semibold">Devices</th>
                  <th className="p-4 text-[16px] text-[#0f2b4c] font-bold">Hub Plus</th>
                  <th className="p-4 text-[16px] text-[#0f2b4c] font-bold">Hub</th>
                  <th className="p-4 text-[16px] text-[#0f2b4c] font-bold">Hub 2 Plus</th>
                  <th className="p-4 text-[16px] text-[#0f2b4c] font-bold">Hub 2 (2G)</th>
                  <th className="p-4 text-[16px] text-[#0f2b4c] font-bold">Hub 2 (4G)</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-slate-200 hover:bg-slate-50">
                  <td className="p-4 text-[16px] text-slate-700">Devices</td>
                  <td className="p-4 text-[16px] text-slate-600">150</td>
                  <td className="p-4 text-[16px] text-slate-600">100</td>
                  <td className="p-4 text-[16px] text-slate-600">200</td>
                  <td className="p-4 text-[16px] text-slate-600">100</td>
                  <td className="p-4 text-[16px] text-slate-600">100</td>
                </tr>
                <tr className="border-b border-slate-200 hover:bg-slate-50">
                  <td className="p-4 text-[16px] text-slate-700">Cameras & DVRs</td>
                  <td className="p-4 text-[16px] text-slate-600">50</td>
                  <td className="p-4 text-[16px] text-slate-600">10</td>
                  <td className="p-4 text-[16px] text-slate-600">100</td>
                  <td className="p-4 text-[16px] text-slate-600">25</td>
                  <td className="p-4 text-[16px] text-slate-600">25</td>
                </tr>
                <tr className="border-b border-slate-200 hover:bg-slate-50">
                  <td className="p-4 text-[16px] text-slate-700">Range extenders</td>
                  <td className="p-4 text-[16px] text-slate-600">5</td>
                  <td className="p-4 text-[16px] text-slate-600">1</td>
                  <td className="p-4 text-[16px] text-slate-600">5</td>
                  <td className="p-4 text-[16px] text-slate-600">5</td>
                  <td className="p-4 text-[16px] text-slate-600">5</td>
                </tr>
                <tr className="border-b border-slate-200 hover:bg-slate-50">
                  <td className="p-4 text-[16px] text-slate-700">Users</td>
                  <td className="p-4 text-[16px] text-slate-600">99</td>
                  <td className="p-4 text-[16px] text-slate-600">50</td>
                  <td className="p-4 text-[16px] text-slate-600">200</td>
                  <td className="p-4 text-[16px] text-slate-600">50</td>
                  <td className="p-4 text-[16px] text-slate-600">50</td>
                ...
                <tr className="border-b border-slate-200 hover:bg-slate-50">
                  <td className="p-4 text-[16px] text-slate-700">Security groups</td>
                  <td className="p-4 text-[16px] text-slate-600">25</td>
                  <td className="p-4 text-[16px] text-slate-600">9</td>
                  <td className="p-4 text-[16px] text-slate-600">25</td>
                  <td className="p-4 text-[16px] text-slate-600">9</td>
                  <td className="p-4 text-[16px] text-slate-600">9</td>
                </tr>
                <tr className="border-b border-slate-200 hover:bg-slate-50">
                  <td className="p-4 text-[16px] text-slate-700">Scenarios²</td>
                  <td className="p-4 text-[16px] text-slate-600">64</td>
                  <td className="p-4 text-[16px] text-slate-600">5</td>
                  <td className="p-4 text-[16px] text-slate-600">64</td>
                  <td className="p-4 text-[16px] text-slate-600">32</td>
                  <td className="p-4 text-[16px] text-slate-600">32</td>
                </tr>
                <tr className="border-b border-slate-200 hover:bg-slate-50">
                  <td className="p-4 text-[16px] text-slate-700">Visual alarm verification support</td>
                  <td className="p-4 text-[16px] text-slate-600">No</td>
                  <td className="p-4 text-[16px] text-slate-600">No</td>
                  <td className="p-4 text-[16px] text-slate-600">Yes</td>
                  <td className="p-4 text-[16px] text-slate-600">Yes</td>
                  <td className="p-4 text-[16px] text-slate-600">Yes</td>
                </tr>
                <tr className="border-b border-slate-200 hover:bg-slate-50">
                  <td className="p-4 text-[16px] text-slate-700">Communication channels</td>
                  <td className="p-4 text-[16px] text-slate-600">2G/3G 2xSIM<br/>Ethernet<br/>Wi-Fi</td>
                  <td className="p-4 text-[16px] text-slate-600">2G 1xSIM<br/>Ethernet</td>
                  <td className="p-4 text-[16px] text-slate-600">2G/3G/4G(LTE) 2xSIM<br/>Ethernet<br/>Wi-Fi</td>
                  <td className="p-4 text-[16px] text-slate-600">2G 2xSIM<br/>Ethernet</td>
                  <td className="p-4 text-[16px] text-slate-600">2G/3G/4G(LTE) 2xSIM<br/>Ethernet</td>
                </tr>
              </tbody>
            </table>
            <p className="text-[14px] text-slate-400 mt-4 max-w-4xl">
              ² Scenarios "By arming and disarming" are not included in the overall limit of the hub’s scenarios. The number of such scenarios depends on how many automation devices are connected to the security system — one scenario per one automation device.
            </p>
            <p className="text-[14px] text-slate-400 mt-2 max-w-4xl">
              ³ GSM 850/900/1800/1900 MHz. ⁴ 2G (GSM 900/DCS 1800), 3G (WCDMA 900/2100, B8/B1). ⁵ LTE (FDD B1/B3/B5/B7/B8/B20).
            </p>
          </div>
        </div>
        ...
        {/* TECHNICAL SPECIFICATIONS */}
        <div>
          <h3 className="text-[32px] lg:text-[40px] font-bold mb-12 text-center text-[#0f2b4c]">Tech Specs</h3>
          
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-0 border-t border-slate-200">
            {/* Left Column */}
            <div className="flex flex-col border-r-0 lg:border-r border-slate-200">
              <div className="flex flex-col sm:flex-row border-b border-slate-200 py-6 pr-0 lg:pr-10 gap-4 sm:gap-8">
                <div className="w-full sm:w-[40%] text-[16px] text-slate-500 font-medium">Colour</div>
                <div className="w-full sm:w-[60%] text-[16px] text-slate-800">
                  white, black
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row border-b border-slate-200 py-6 pr-0 lg:pr-10 gap-4 sm:gap-8">
                <div className="w-full sm:w-[40%] text-[16px] text-slate-500 font-medium">Compliance</div>
                <div className="w-full sm:w-[60%] text-[16px] text-slate-800">
                  EN 50131 (Grade 2)<br/>
                  PD 6662:2017
                </div>
              ...
              <div className="py-6 pr-0 lg:pr-10 border-b border-slate-200">
                 <h4 className="text-[20px] font-bold text-[#0f2b4c] mb-6">Communication</h4>
                 <div className="space-y-6">
                    <div className="flex flex-col sm:flex-row gap-4 sm:gap-8">
                      <div className="w-full sm:w-[40%] text-[16px] text-slate-500 font-medium">Communication channels</div>
                      <div className="w-full sm:w-[60%] text-[16px] text-slate-800 leading-relaxed">
                         2G (GSM900/DCS1800 (B3/B8))<br/>
                         3G (WCDMA 850/900/2100 (B1/B5/B8))<br/>
                         LTE (FDD B1/B3/B5/B7/B8/B20)<br/>
                         Ethernet
                      </div>
                    </div>
                    <div className="flex flex-col sm:flex-row gap-4 sm:gap-8">
                      <div className="w-full sm:w-[40%] text-[16px] text-slate-500 font-medium">CMS connectivity</div>
                      <div className="w-full sm:w-[60%] text-[16px] text-slate-800 leading-relaxed">
                         SurGard (Contact ID)<br/>
                         SIA (DC-09)<br/>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 sm:gap-8">
                      <div className="w-full sm:w-[40%] text-[16px] text-slate-500 font-medium">Communication protocols</div>
                      <div className="w-full sm:w-[60%] text-[16px] text-slate-800 leading-relaxed">
                         <strong>Jeweller:</strong> two-way encrypted communication of events and alarms<br/><br/>
                         <strong>Wings:</strong> two-way encrypted communication of photo verifications
                      </div>
                    </div>
                 </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row border-b border-slate-200 lg:border-b-0 py-6 pr-0 lg:pr-10 gap-4 sm:gap-8">
                <div className="w-full sm:w-[40%] text-[16px] text-slate-500 font-medium">Radio communication range</div>
                <div className="w-full sm:w-[60%] text-[16px] text-slate-800">
                  up to 2,000 m (Jeweller)<br/>
                  up to 1,700 m (Wings)
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col lg:pl-10">
              <div className="flex flex-col sm:flex-row border-b border-slate-200 py-6 gap-4 sm:gap-8">
                <div className="w-full sm:w-[40%] text-[16px] text-slate-500 font-medium">Frequency band</div>
                <div className="w-full sm:w-[60%] text-[16px] text-slate-800">
                  868.0−868.6 MHz<br/>
                  868.7–869.2 MHz<br/>
                  863.0–870.0 MHz<br/>
                  <span className="text-slate-500 text-sm">(depends on the region of sale)</span>
                </div>
              </div>
              <div className="flex flex-col sm:flex-row border-b border-slate-200 py-6 gap-4 sm:gap-8">
                <div className="w-full sm:w-[40%] text-[16px] text-slate-500 font-medium">Maximum effective radiated power (ERP)</div>
                <div className="w-full sm:w-[60%] text-[16px] text-slate-800">≤ 25 mW</div>
              </div>
              <div className="flex flex-col sm:flex-row border-b border-slate-200 py-6 gap-4 sm:gap-8">
                <div className="w-full sm:w-[40%] text-[16px] text-slate-500 font-medium">Alarms delivery speed</div>
                <div className="w-full sm:w-[60%] text-[16px] text-slate-800">0.15 seconds</div>
              </div>
              <div className="flex flex-col sm:flex-row border-b border-slate-200 py-6 gap-4 sm:gap-8">
                <div className="w-full sm:w-[40%] text-[16px] text-slate-500 font-medium">Photos delivery speed</div>
                <div className="w-full sm:w-[60%] text-[16px] text-slate-800">
                  9 seconds<br/>
                  <span className="text-slate-500 text-sm">(default settings)</span>
                </div>
              </div>
              
              <div className="py-6 border-b border-slate-200">
                 <h4 className="text-[20px] font-bold text-[#0f2b4c] mb-6">Power supply</h4>
                 <div className="space-y-6">
                    <div className="flex flex-col sm:flex-row gap-4 sm:gap-8">
                      <div className="w-full sm:w-[40%] text-[16px] text-slate-500 font-medium">Power supply</div>
                      <div className="w-full sm:w-[60%] text-[16px] text-slate-800">110–240 V, 50/60 Hz</div>
                    </div>
                    <div className="flex flex-col sm:flex-row gap-4 sm:gap-8">
                      <div className="w-full sm:w-[40%] text-[16px] text-slate-500 font-medium">Backup power supply</div>
                      <div className="w-full sm:w-[60%] text-[16px] text-slate-800">
                        Li-Ion 2 Ah<br/>
                        <span className="text-slate-500 text-sm">(up to 16 hours of autonomous operation)</span>
                      </div>
                    </div>
                 </div>
              </div>
              ...
              <div className="py-6 border-b border-slate-200">
                 <h4 className="text-[20px] font-bold text-[#0f2b4c] mb-6">Antisabotage protection</h4>
                 <div className="space-y-6">
                    <div className="flex flex-col sm:flex-row gap-4 sm:gap-8">
                      <div className="w-full sm:w-[40%] text-[16px] text-slate-500 font-medium">Tampering alarm</div>
                      <div className="w-full sm:w-[60%] text-[16px] text-slate-800">+</div>
                    </div>
                    <div className="flex flex-col sm:flex-row gap-4 sm:gap-8">
                      <div className="w-full sm:w-[40%] text-[16px] text-slate-500 font-medium">Pings</div>
                      <div className="w-full sm:w-[60%] text-[16px] text-slate-800">
                        12–300 sec<br/>
                        <span className="text-slate-500 text-sm">(set by an admin in the app)</span>
                      </div>
                    </div>
                    <div className="flex flex-col sm:flex-row gap-4 sm:gap-8">
                      <div className="w-full sm:w-[40%] text-[16px] text-slate-500 font-medium">Frequency hopping</div>
                      <div className="w-full sm:w-[60%] text-[16px] text-slate-800">+</div>
                    </div>
                    <div className="flex flex-col sm:flex-row gap-4 sm:gap-8">
                      <div className="w-full sm:w-[40%] text-[16px] text-slate-500 font-medium">Protection against forgery</div>
                      <div className="w-full sm:w-[60%] text-[16px] text-slate-800">+</div>
                    </div>
                 </div>
              </div>
              ...
              <div className="py-6">
                 <h4 className="text-[20px] font-bold text-[#0f2b4c] mb-6">Body and complete set</h4>
                 <div className="space-y-6">
                    <div className="flex flex-col sm:flex-row gap-4 sm:gap-8">
                      <div className="w-full sm:w-[40%] text-[16px] text-slate-500 font-medium">Operating temperature range</div>
                      <div className="w-full sm:w-[60%] text-[16px] text-slate-800">from –10°С to +40°С</div>
                    </div>
                    <div className="flex flex-col sm:flex-row gap-4 sm:gap-8">
                      <div className="w-full sm:w-[40%] text-[16px] text-slate-500 font-medium">Operating humidity</div>
                      <div className="w-full sm:w-[60%] text-[16px] text-slate-800">up to 75%</div>
                    </div>
                    <div className="flex flex-col sm:flex-row gap-4 sm:gap-8">
                      <div className="w-full sm:w-[40%] text-[16px] text-slate-500 font-medium">Overall dimensions</div>
                      <div className="w-full sm:w-[60%] text-[16px] text-slate-800">163 × 163 × 36 mm</div>
                    </div>
                    <div className="flex flex-col sm:flex-row gap-4 sm:gap-8">
                      <div className="w-full sm:w-[40%] text-[16px] text-slate-500 font-medium">Weight</div>
                      <div className="w-full sm:w-[60%] text-[16px] text-slate-800">362 g</div>
                    </div>
                    <div className="flex flex-col sm:flex-row gap-4 sm:gap-8">
                      <div className="w-full sm:w-[40%] text-[16px] text-slate-500 font-medium">Complete set</div>
                      <div className="w-full sm:w-[60%] text-[16px] text-slate-800 leading-relaxed">
