...
pdf_path = r"c:\react project\sv2\scratch\fire_protect_2_heat_smoke_co_8in.pdf"
url = "https://drive.google.com/uc?id=1z4STp0WsCD3y3pVxXGx19M0FaduA79jy"

print("Downloading Fire Protect 2 (Heat/Smoke/CO) (8IN) PDF...")
...
if os.path.exists(pdf_path):
    ...
    # Render PNGs
    output_dir = r"c:\react project\sv2\public\images\products\fire-protect-2-heat-smoke-co-8in"
