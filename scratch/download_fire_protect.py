...
pdf_path = r"c:\react project\sv2\scratch\fire_protect_8in.pdf"
url = "https://drive.google.com/uc?id=10zfJhXyiiCZ682Ux0olIBRIK5eL0F1Sk"

print("Downloading Fire Protect (8IN) PDF...")
...
if os.path.exists(pdf_path):
    ...
    # Render PNGs
    output_dir = r"c:\react project\sv2\public\images\products\fire-protect-8in"
