...
pdf_path = r"c:\react project\sv2\scratch\fire_protect_2_heat_smoke_8in.pdf"
url = "https://drive.google.com/uc?id=1DSCn8Kv-YCImMdXvXnFrUsdVF3mM-nwh"

print("Downloading Fire Protect 2 (Heat/Smoke) (8IN) PDF...")
...
if os.path.exists(pdf_path):
    ...
    # Render PNGs
    output_dir = r"c:\react project\sv2\public\images\products\fire-protect-2-heat-smoke-8in"
