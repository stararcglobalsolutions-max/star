...
pdf_path = r"c:\react project\sv2\scratch\double_button_8in.pdf"
url = "https://drive.google.com/uc?id=1YIjiyAWiRbsHotWjVrYPuftky81TQamv"

print("Downloading Double Button (8IN) PDF...")
...
if os.path.exists(pdf_path):
    ...
    # Render PNGs - use 280pt default first, we'll adjust after seeing positions
    output_dir = r"c:\react project\sv2\public\images\products\double-button-8in"
