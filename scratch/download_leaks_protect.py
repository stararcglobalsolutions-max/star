...
pdf_path = r"c:\react project\sv2\scratch\leaks_protect_8in.pdf"
url = "https://drive.google.com/uc?id=1HjAZWrd85WBQIWBkwQkVvVTwYxyDwVEV"

print("Downloading Leaks Protect (8IN) PDF...")
...
if os.path.exists(pdf_path):
    ...
    # Render PNGs
    output_dir = r"c:\react project\sv2\public\images\products\leaks-protect-8in"
