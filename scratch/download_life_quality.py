...
pdf_path = r"c:\react project\sv2\scratch\life_quality_8in.pdf"
url = "https://drive.google.com/uc?id=1Zxy8xvIS4TwPoOgCrghw4B7wXFqCJs9I"

print("Downloading Life Quality (8IN) PDF...")
...
if os.path.exists(pdf_path):
    ...
    # Render PNGs
    output_dir = r"c:\react project\sv2\public\images\products\life-quality-8in"
